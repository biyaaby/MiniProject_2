...
from .models import PasswordReset, User, TeacherRequest
from .forms import TeacherRequestForm, ContactUsForm
from django.http import HttpResponseRedirect
from django.urls import reverse
from django.http import HttpResponse
from .models import Category, SubCategory, ContactUs
...
def update_request_status(request, request_id, status):
    ...
    return HttpResponseRedirect(reverse('admin:app_teacherrequest_changelist'))  # Redirect back to admin list view
...
def teacher_requests(request):
    ...
    return render(request, 'teacher_requests.html', {'requests': requests})
...
def teacher_requests(request):
    ...
    return render(request, 'teacher_requests.html', {'teacher_requests': teacher_requests})
